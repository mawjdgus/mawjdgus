...
class Generator(nn.Module):
    def __init__(self, z_dim, in_channels, img_channels=3):
        ...
        for i in range(len(factors) - 1):
            ...
            conv_in_c = int(in_channels * factors[i]) # 1, 1, 1, 1, 1/2, 1/4, 1/8, 1/16, 1/32
    ...
    def forward(self, x, alpha, steps): # if steps=0 (4x4), steps=1 (8x8), ...
        ...
        return self.fadein(alpha, final_upscaled, final_out)
...
class Discriminator(nn.Module):
    def __init__(self, z_dim, in_channels, img_channels=3):
        ...
        # tihs is for 4x4 img resolution
